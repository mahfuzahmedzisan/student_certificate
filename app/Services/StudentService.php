...
class StudentService
{
    public function __construct(
        protected StudentRepositoryInterface $interface,
    ...
    * ================== ================== ================== */
    ...
    public function findData($column_value, string $column_name = 'id'): ?Student
    {
    ...
    * ================== ================== ================== */
    ...
    public function createData(array $data): Student
    {
        return $this->createAction->execute(data: $data);
    }

    public function updateData(int $id, array $data): Student
    {
    ...
    public function updateStatusData(int $id, StudentStatus $status, ?int $actionerId = null): Student
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
    ...
    public function bulkUpdateStatus(array $ids, StudentStatus $status, ?int $actionerId = null): int
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
